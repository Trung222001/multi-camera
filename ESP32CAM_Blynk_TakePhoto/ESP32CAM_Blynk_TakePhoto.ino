//www.prateeks.in
//YouTube Video Link :- https://youtu.be/ju0JU0IBrvY
...
const char* ssid = "JustDo";             //wifi name
const char* password = "par12345";       //password
char auth[] = "ksffiuehfeiufheutreaja";  //Auth Code sent by Blynk
